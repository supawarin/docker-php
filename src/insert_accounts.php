              ...
              <div class="dropdown">
               ...
               <div class="name_table">
                   <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Add New Accounts</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Overview</li>

                        </ol>
                    </nav>
                   <h2>Add New Accounts </h2><br />

                   <form method="POST" action="" class="row g-3" name="new_account" >
                       <div class="col-md-5">
                       ...
                       <div class="col-md-5">
                          ...
                          <input type="password" class="form-control" placeholder="Confirm Password" aria-label="cpassword">
                       </div><br /><br />
