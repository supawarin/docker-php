      ...
      <div class="main-content">
          <header>
              <p>
                  ...
                  </label><span class="accueil">Add New Employee</span>
              ...
              <div class="dropdown">
               ...
               <div class="name_table">
                   ...
                   <form method="POST" action="insert_employee.php" class="row g-3" name="new_employee" >
                       
                       <div class="col-md-5">
                           <label for="firstname" class="form-label">Firstname</label>
                          <input type="text" name="firstname" class="form-control" placeholder="firstname" aria-label="firstname" required />
                       </div><br /><br />
                       <div class="col-md-5">
                       ...
                       <div class="col-md-5">
                          ...
                          <input type="text" name="rate" class="form-control" placeholder="rate" aria-label="rate" >
                       </div><br /><br />
                       <div class="col-md-5">
