      ...
      <div class="sidebar">
          ...
          <div class="sidebar-menu">
              <ul>
                  ...
                  <li>
                      <a href="model.php" class="nav-link active "><span class="las la-car-side"></span>
      ...
      <div class="main-content">
          <header>
              <p>
                  ...
                  </label><span class="accueil">Edit Model Cars</span>
              ...
              <div class="dropdown">
               ...
               <div class="name_table">
                   <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="model.php"> Model cars list</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Overview</li>

                        </ol>
                    </nav>
                   <h2>Edit Model Cars </h2><br />

                   


                   <form method="POST" action="update_model.php" class="row g-3" name="edit_model" >
                       <div class="col-md-5">
                           <label for="id_model" class="form-label">ID </label>
                          <input type="number" name="id_model"  class="form-control" readonly value=<?=$row['id']?> >
                       </div>
                       <div class="col-md-5">
                       ...
                       <div class="col-md-5">
                          ...
                          <input type="text" name="make"  class="form-control"  aria-label="make" value=<?=$row['make']?>>
                       </div>
                       <div class="col-md-5">
                           <label for="price" class="form-label">price</label>
                          <input type="text" name="price" class="form-control" aria-label="price" value=<?=$row['price']?> >
                       </div><br /><br />
                       <div class="col-md-10">
                           <label for="color" class="form-label">color</label>
                           <p><?=$row['color']?></p> 
                           <input type="text" name="color" class="form-control" aria-label="color" value=<?=$row['color']?> >  
                       </div>
                       <div class="col-6">
                           <label for="image" class="form-label">image</label>
                           <?php echo '<img src="data:image;base64,'.base64_encode($row["image"]).'"alt="Image" style="width: 500px; height:300px;">'; ?>
                           <br /><br /><br />
                           <div class="input-group col-4">
                          <input type="file" class="form-control" id="input_image" name="input_image">
                          <label class="input-group-text" for="input_model">Upload</label>
                       </div>
                       </div>
                       ...
                       <a href="model.php" class="btn btn-danger">Cancel</a>
