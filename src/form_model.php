      ...
      <div class="main-content">
          <header>
              <p>
                  ...
                  </label><span class="accueil">Add New Model Cars</span>
              ...
              <div class="dropdown">
               ...
               <div class="name_table">
                   ...
                   <h2>Add New Model Cars </h2><br />

                   


                   <form method="POST" action="insert_model.php" class="row g-3" name="edit_model" >
                       <div class="col-md-5">
                           <label for="id_model" class="form-label">ID </label>
                          <input type="number" name="id_model"  class="form-control"  require >
                       </div>
                       <div class="col-md-5">
                       ...
                       <div class="col-md-5">
                          ...
                          <input type="text" name="make"  class="form-control"  aria-label="make" require>
                       </div>
                       <div class="col-md-5">
                           <label for="price" class="form-label">price</label>
                          <input type="text" name="price" class="form-control" aria-label="price" require >
                       </div><br /><br />
                       <div class="col-md-10">
                           <label for="color" class="form-label">color</label>
                           <p><?=$row['color']?></p> 
                           <input type="text" name="color" class="form-control" aria-label="color" require >  
                       </div>
                       <div class="col-6">
