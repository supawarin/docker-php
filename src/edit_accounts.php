...
<html lang="en">
  ...
  <head>
      ...
      <title>Edit Accounts Page</title>
          ...
          <header>
              ...
              <div class="dropdown">
               ...
               <div class="name_table">
                   ...
                   <h2>Edit Accounts / user </h2><br />

                   


                   <form method="POST" action="update_accounts.php" class="row g-3" name="edit_account" >
                       <div class="col-md-10">
                           <label for="id_user" class="form-label">ID User</label>
                          <input type="number" name="id_user"  class="form-control" readonly value=<?=$row['id']?> >
                       </div>
                       <div class="col-md-10">
                           <label for="status" class="form-label">Status</label>
                          <input type="text" name="status"  class="form-control" readonly value=<?=$row['status']?> >
                       </div>
                       <div class="col-md-10">
                           <label for="firstname" class="form-label">Firstname</label>
                          <input type="text" name="firstname"  class="form-control"  aria-label="First name" value=<?=$row['firstname']?>>
                       </div>
                       <div class="col-md-10">
                           <label for="lastname" class="form-label">Lastname</label>
                          <input type="text" name="lastname" class="form-control" aria-label="Last name" value=<?=$row['lastname']?> >
                       </div><br /><br />
                       <div class="col-10">
                       ...
                       <div class="col-md-10">
                          ...
                          <input type="password" name="password" class="form-control"  aria-label="password" value=<?=$row['password']?>>
                       </div>
                       <div class="col-md-10">
                           <label for="confirm_password" class="form-label">Confirm Password</label>
                          <input type="password" name="confirm_password" class="form-control"  aria-label="confirm_password" value=<?=$row['password']?>>
                       </div><br /><br />
                       <div class="col-12">
