...
<html lang="en">
  ...
  <body>
      ...
      <div class="main-content">
          <header>
              <p>
                  ...
                  </label><span class="accueil">Timeslips</span>
               ...
               <div class="name_table">
                 ...
                 <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="edit_timeslip.php?id=<?=$row["id"]?>" class="btn btn-warning">Edit</a></td>
                            <td><a href="delete_timslip.php?id=<?=$row["id"]?>" class="btn btn-danger" onclick="Del(this.href);return false;">Delete</a></td>
                       </tr>
                         <?php endwhile ?>
                    </tbody>
     ...
     <script>
         ...
         $('#list-timeslips').DataTable();
         } );
     </script>

     <script language="JavaScript">
         function Del(mypage){
             var agree=confirm("Do you want to delete timeslip data?");
             if(agree){
