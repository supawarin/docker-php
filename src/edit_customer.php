...
<html lang="en">
  ...
  <head>
      ...
      <title>Edit Customers Page</title>
      ...
      <div class="main-content">
          <header>
              <p>
                  ...
                  </label><span class="accueil">Edit Customers</span>
              ...
              <div class="dropdown">
               ...
               <div class="name_table">
                   ...
                   <h2>Edit Customers  </h2><br />

                   <form method="POST" action="update_customer.php" class="row g-3" name="new_customer" >
                       <div class="col-md-5">
                       ...
                       <div class="col-md-5">
                          ...
                          <input type="text" name="company" class="form-control"  aria-label="company" value=<?=$row['company']?>>
                       </div><br /><br />
                       <div class="col-md-5">
                           <label for="contact" class="form-label">Contact Name</label>
                          <input type="text" name="contact" class="form-control"  aria-label="contact" value=<?=$row['contact']?>>
                       </div><br /><br />
                       <div class="col-5">
                           <label for="email" class="form-label">Email</label>
                          <input type="email" name="email" class="form-control"  aria-label="email" value=<?=$row['email']?>>
                       </div>
                       <div class="col-md-10">
                           <label for="address" class="form-label">Address</label>
                          <input type="text" name="address" class="form-control"  aria-label="address" value=<?=$row['address']?>>
                       </div>
                       <div class="col-md-5">
                           <label for="city" class="form-label">City</label>
                          <input type="text" name="city" class="form-control"  aria-label="city" value=<?=$row['city']?> >
                       </div><br /><br />
                       <div class="col-md-5">
                           <label for="country" class="form-label">Country</label>
                          <input type="text" name="country" class="form-control"  aria-label="country" value=<?=$row['country']?>>
                       </div><br /><br />
                       <div class="col-md-5">
                           <label for="post" class="form-label">Post Code</label>
                          <input type="text" name="post" class="form-control"  aria-label="post" value=<?=$row['post']?>>
                       </div><br /><br />
                       <div class="col-md-5">
                           <label for="phone" class="form-label">Phone Number</label>
                          <input type="text" name="phone" class="form-control" aria-label="phone" value=<?=$row['phone']?>>
                       </div><br /><br />
                       <div class="col-md-10">
                           <label for="note">Note</label>
                           <textarea class="form-control" rows="5"  id="note" name="note" value=<?=$row['note']?>></textarea>
                       </div>
                       <div class="col-12">
