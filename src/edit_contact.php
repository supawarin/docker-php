      ...
      <div class="sidebar">
          ...
          <div class="sidebar-menu">
              <ul>
                  ...
                  <li>
                      <a href="contact.php" class="nav-link active"><span class="las la-address-book"></span>
      ...
      <div class="main-content">
          <header>
              <p>
                  ...
                  </label><span class="accueil">Edit Contact</span>
              ...
              <div class="dropdown">
               ...
               <div class="name_table">
                   ...
                   <form method="POST" action="update_contact.php" class="row g-3" name="edit_contact" >
                       <div class="col-md-5">
                           <label for="id_contact" class="form-label">ID contact</label>
                          <input type="number" name="id_contact"  class="form-control" readonly value=<?=$row['id']?> >
                       </div>
